      ...
      <form className="max-w-2xl mx-auto" action={handleSubmit}>
        <div className="my-2">
          ...
          <input
            ...
            name="name"
            id="name"
            className="block w-full p-2 text-gray-200 border border-gray-500 rounded-lg bg-gray-600 text-xm  dark:bg-gray-600 dark:border-gray-600 dark:placeholder-gray-100 dark:text-white  dark:focus:border-blue-500"
          />
        </div>
        {/* input for email */}
        <div className="my-2">
        ...
        <div className="my-2 relative ">
          ...
          <button
            ...
            className="absolute right-3  top-[38px] text-gray-300 hover:text-white text-base cursor-pointer"
          >
            {showPassword ? "👁️" : "🙈"}
          </button>
        </div>
